...
<div class="bg-white shadow-md rounded-lg overflow-hidden">
    <div class="px-6 py-4 bg-emerald-600">
        <h1 class="text-xl font-bold text-white">Jadwal Mengajar</h1>
    </div>
    <div class="p-6">
        @php
                        ...
                        <table class="w-full table-auto border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-700">{{ $jadwal->kelas->nama ?? $jadwal->nama_kelas ?? '-' }}</td>
                                    <td class="px-4 py-3 text-sm text-gray-700">{{ $jadwal->jam_mulai ? \Carbon\Carbon::parse($jadwal->jam_mulai)->format('H:i') : '-' }} - {{ $jadwal->jam_selesai ? \Carbon\Carbon::parse($jadwal->jam_selesai)->format('H:i') : '-' }}</td>
