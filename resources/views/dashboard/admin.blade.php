...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex items-center space-x-4">
        <div class="w-14 h-14 bg-emerald-100 rounded-xl flex items-center justify-center text-2xl">👦</div>
        <div>
            <p class="text-gray-500 text-sm">Total Santri</p>
            <p class="text-3xl font-bold text-gray-800">{{ $totalSantri ?? 0 }}</p>
        </div>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-3xl font-bold text-gray-800">{{ $totalGuru ?? 0 }}</p>
        </div>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex items-center space-x-4">
        <div class="w-14 h-14 bg-amber-100 rounded-xl flex items-center justify-center text-2xl">🏛️</div>
        <div>
            <p class="text-gray-500 text-sm">Total Kelas</p>
            <p class="text-3xl font-bold text-gray-800">{{ $totalKelas ?? 0 }}</p>
        </div>
    </div>
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-3xl font-bold text-gray-800">{{ $totalMapel ?? 0 }}</p>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        <h2 class="text-lg font-semibold text-gray-800 mb-2">KRS Pending</h2>
        <p class="text-4xl font-bold text-amber-600">{{ $krsPending ?? 0 }}</p>
