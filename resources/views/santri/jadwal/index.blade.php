...
<div class="bg-white shadow-md rounded-lg overflow-hidden">
    <div class="px-4 sm:px-6 py-4 bg-emerald-600">
        <h1 class="text-lg sm:text-xl font-bold text-white">Jadwal Pelajaran Saya</h1>
    </div>
                        ...
                        <table class="w-full table-auto border-collapse table-card">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-4 py-3 text-sm text-gray-700" data-label="Jam">
                                    ...
                                    <td class="px-4 py-3 text-sm text-gray-700" data-label="Guru">{{ $jadwal->guru->nama_lengkap ?? $jadwal->nama_guru ?? '-' }}</td>
