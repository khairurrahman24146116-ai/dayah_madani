...
<div class="print-area max-w-4xl mx-auto bg-white p-8">
    ...
    <div class="mt-8 grid grid-cols-2 gap-16">
        <div>
            <p class="text-sm font-semibold border-t border-gray-400 pt-1 text-center mt-16">Santri</p>
        </div>
        <div>
            <p class="text-sm font-semibold border-t border-gray-400 pt-1 text-center mt-16">Wali Kelas</p>
        </div>
    </div>
...
<div class="text-center mt-4 no-print">
    ...
    <a href="{{ route('santri.krs.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg text-sm font-medium transition ml-2">Kembali</a>
</div>
@push('styles')
<style>
