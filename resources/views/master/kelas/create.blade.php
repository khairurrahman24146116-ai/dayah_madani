...
<div class="bg-white shadow-md rounded-lg overflow-hidden">
    <div class="px-4 sm:px-6 py-4 bg-emerald-600">
        <h1 class="text-lg sm:text-xl font-bold text-white">Tambah Kelas</h1>
    </div>
    <div class="p-4 sm:p-6">
        <form action="{{ route('admin.kelas.store') }}" method="POST">
            ...
            <div class="mobile-stack">
                ...
                <a href="{{ route('admin.kelas.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg text-sm font-medium transition text-center w-full sm:w-auto">Kembali</a>
            </div>
        </form>
    </div>
</div>
